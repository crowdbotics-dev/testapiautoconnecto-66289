...
## Project Structure
    ...
    ├── testapiautoconnecto_66289  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_66289`
...
2. Clone this repo and `cd testapiautoconnecto_66289`
